...
## API 基本信息[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#api-%E5%9F%BA%E6%9C%AC%E4%BF%A1%E6%81%AF "API 基本信息的直接链接")
...
### HTTP 返回代码[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#http-%E8%BF%94%E5%9B%9E%E4%BB%A3%E7%A0%81 "HTTP 返回代码的直接链接")
...
### 接口错误代码[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E6%8E%A5%E5%8F%A3%E9%94%99%E8%AF%AF%E4%BB%A3%E7%A0%81 "接口错误代码的直接链接")
...
- 具体的错误码及其解释在 [错误代码](https://developers.binance.com/docs/zh-CN/wallet/general-info#cf68bca02a).

### 接口的基本信息[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E6%8E%A5%E5%8F%A3%E7%9A%84%E5%9F%BA%E6%9C%AC%E4%BF%A1%E6%81%AF "接口的基本信息的直接链接")
...
## 访问限制[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E8%AE%BF%E9%97%AE%E9%99%90%E5%88%B6 "访问限制的直接链接")

### 访问限制基本信息[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E8%AE%BF%E9%97%AE%E9%99%90%E5%88%B6%E5%9F%BA%E6%9C%AC%E4%BF%A1%E6%81%AF "访问限制基本信息的直接链接")
...
### IP 访问限制[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#ip-%E8%AE%BF%E9%97%AE%E9%99%90%E5%88%B6 "IP 访问限制的直接链接")
...
### WEB SOCKET 连接限制[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#web-socket-%E8%BF%9E%E6%8E%A5%E9%99%90%E5%88%B6 "WEB SOCKET 连接限制的直接链接")
...
### /api/ 与 /sapi/ 接口限频说明[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#api-%E4%B8%8E-sapi-%E6%8E%A5%E5%8F%A3%E9%99%90%E9%A2%91%E8%AF%B4%E6%98%8E "/api/ 与 /sapi/ 接口限频说明的直接链接")
...
## 数据来源[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E6%95%B0%E6%8D%AE%E6%9D%A5%E6%BA%90 "数据来源的直接链接")
...
## 请求鉴权类型[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E8%AF%B7%E6%B1%82%E9%89%B4%E6%9D%83%E7%B1%BB%E5%9E%8B "请求鉴权类型的直接链接")

- 每个接口都有一个鉴权类型，指示所需的 API 密钥权限，显示在接口名称旁边（例如，[下新订单 (TRADE)](https://developers.binance.com/docs/zh-CN/wallet/general-info#place-new-order-trade)）。
- 如果未指定，则鉴权类型为 `NONE`。
- 除了为 `NONE` 外，所有具有鉴权类型的接口均视为 `SIGNED` 请求（即包含 `signature`），[listenKey 管理](https://developers.binance.com/docs/zh-CN/wallet/general-info#user-data-stream-requests) 除外。
...
### 需要签名的接口[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E9%9C%80%E8%A6%81%E7%AD%BE%E5%90%8D%E7%9A%84%E6%8E%A5%E5%8F%A3 "需要签名的接口的直接链接")

- 调用`SIGNED` 接口时，除了接口本身所需的参数外，还需要在 `query string` 或 `request body` 中传递 `signature`, 即签名参数。

#### 签名是否是大小写敏感的[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E7%AD%BE%E5%90%8D%E6%98%AF%E5%90%A6%E6%98%AF%E5%A4%A7%E5%B0%8F%E5%86%99%E6%95%8F%E6%84%9F%E7%9A%84 "签名是否是大小写敏感的的直接链接")

- **HMAC：** 使用 HMAC 生成的签名**不区分大小写**。这意味着无论字母大小写如何，签名字符串都可以被验证。
- **RSA：** 使用 RSA 生成的签名是**大小写敏感的**。
- **Ed25519：** 使用 Ed25519 生成的签名也是**大小写敏感的**。

请参阅[已签名请求示例 (HMAC)](https://developers.binance.com/docs/zh-CN/wallet/general-info#hmac-keys)、[已签名请求示例 (RSA)](https://developers.binance.com/docs/zh-CN/wallet/general-info#rsa-keys) 和[已签名请求示例 (Ed25519)](https://developers.binance.com/docs/zh-CN/wallet/general-info#ed25519-keys)，了解如何根据您使用的 API 密钥类型计算签名。

[](https://developers.binance.com)

### 时间同步安全[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#%E6%97%B6%E9%97%B4%E5%90%8C%E6%AD%A5%E5%AE%89%E5%85%A8 "时间同步安全的直接链  接")

- `SIGNED` 请求还需要一个 `timestamp` 参数，该参数应为当前时间戳，单位为毫秒或微秒。（参见 [通用 API 信息](https://developers.binance.com/docs/zh-CN/wallet/general-info#general-api-information)）
...
### POST /api/v3/order 的签名示例[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#post-apiv3order-%E7%9A%84%E7%AD%BE%E5%90%8D%E7%A4%BA%E4%BE%8B "POST /api/v3/order 的签名示例的直接链接")

#### HMAC Keys[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#hmac-keys "HMAC Keys的直接链接")
...
#### RSA Keys[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#rsa-keys "RSA Keys的直接链接")
...
#### Ed25519 Keys[​](https://developers.binance.com/docs/zh-CN/wallet/general-info#ed25519-keys "Ed25519 Keys的直接链接")
