...
## API Description[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-withdraw#api-description "API Description的直接链接")

Submit a withdrawal request for brokers of local entities that required travel rule.

## HTTP Request[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-withdraw#http-request "HTTP Request的直接链接")

POST `/sapi/v1/localentity/broker/withdraw/apply`

## Request Weight(UID)[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-withdraw#request-weightuid "Request Weight(UID)的直接链接")

**600**

## Request Parameters[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-withdraw#request-parameters "Request Parameters的直接链接")
...
## StandardPii[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-withdraw#standardpii "StandardPii的直接链接")
...
## Response Example[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-withdraw#response-example "Response Example的直接链接")
