...
## API Description[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-deposit-provide-info#api-description "API Description的直接链接")
...
## HTTP Request[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-deposit-provide-info#http-request "HTTP Request的直接链接")

PUT `/sapi/v1/localentity/broker/deposit/provide-info`

## Request Weight(UID)[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-deposit-provide-info#request-weightuid "Request Weight(UID)的直接链接")

**600**

## Request Parameters[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-deposit-provide-info#request-parameters "Request Parameters的直接链接")
...
## StandardPii[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-deposit-provide-info#standardpii "StandardPii的直接链接")
...
## Response Example[​](https://developers.binance.com/docs/zh-CN/wallet/travel-rule/broker-deposit-provide-info#response-example "Response Example的直接链接")
