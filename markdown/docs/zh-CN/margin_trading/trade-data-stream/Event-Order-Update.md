...
## 事件描述[​](https://developers.binance.com/docs/zh-CN/margin_trading/trade-data-stream/Event-Order-Update#%E4%BA%8B%E4%BB%B6%E6%8F%8F%E8%BF%B0 "事件描述的直接链接")
...
- TRADE\_PREVENTION - 订单因 STP 触发而过期。

请查阅[公开API参数](https://developers.binance.com/docs/zh-CN/margin_trading/trade-data-stream/Event-Order-Update#public-api-definitions)文档获取更多枚举定义。

**备注:** 通过将`Z`除以`z`可以找到平均价格。

如果订单是OCO，则除了显示`executionReport`事件外，还将显示一个名为`ListStatus`的事件。

### `executionReport` 中的仅在满足特定条件时才会出现的字段：[​](https://developers.binance.com/docs/zh-CN/margin_trading/trade-data-stream/Event-Order-Update#executionreport-%E4%B8%AD%E7%9A%84%E4%BB%85%E5%9C%A8%E6%BB%A1%E8%B6%B3%E7%89%B9%E5%AE%9A%E6%9D%A1%E4%BB%B6%E6%97%B6%E6%89%8D%E4%BC%9A%E5%87%BA%E7%8E%B0%E7%9A%84%E5%AD%97%E6%AE%B5 "executionreport-中的仅在满足特定条件时才会出现的字段的直接链接")
...
## 事件类型[​](https://developers.binance.com/docs/zh-CN/margin_trading/trade-data-stream/Event-Order-Update#%E4%BA%8B%E4%BB%B6%E7%B1%BB%E5%9E%8B "事件类型的直接链接")

`executionReport`

## 响应示例[​](https://developers.binance.com/docs/zh-CN/margin_trading/trade-data-stream/Event-Order-Update#%E5%93%8D%E5%BA%94%E7%A4%BA%E4%BE%8B "响应示例的直接链接")
